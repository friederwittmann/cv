...
%---------------------------------------------------------
  \cventry
    ...
    {Incremed AG / Comerge AG} % Organization
    {Zurich, Switzerland} % Location
    {Sep 2021 - Jan 2024} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Computer vision R\&D in cross-functional teams in healthcare and mixed reality}
        \item {Monocular camera based 6 DOF tracking system for surgical navigation}
        \item {3D object reconstruction from point clouds}
        \item {Attention analysis using eye tracking}
        \item {Technical validation and procedures for regulatory approval for medical devices}
        \item {Collaboration with surgeons, UX experts and software engineers}
        \item {Ensured software development process quality, including unit tests and source code reviews}        
        \item {Key technologies: C++, OpenCV, Python, C\#, Unity 3D, Git}
      \end{cvitems}
    }
  ...
  \cventry
    ...
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Project lead in multiple engineering projects on optimization of Wheelchairs and Sport Climbing}
        \item {Collaboration with Sauber Engineering and Orthotec for paralympic athlete Marcel Hug, which supported his wins at the Tokyo \& Paris Paralympics: 5 Gold, 2 Silver, 1 Bronze medals as well as one world record (1500m). The project was featured multiple times on Swiss public television (SRF).}
        ...
        \item {Development of a force controlled robotic device to train and rehabilitate finger strength}
        ...
        \item {Key technologies used for these projects:\\C, C++, ARM, freeRTOS, ROS, Python 3.7, PyQt, Jupyter, MATLAB, Solidworks (CAD)}
  ...
  \cventry
    ...
    {Nov 2010 - May 2011} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        ...
        \item {Feasible trajectory planning with {rapidly exploring randomized trees (RRTs)}} 
...
%---------------------------------------------------------
  \cventry
    ...
    {Nov 2009 - April 2010} % Date(s)
    {
      ...
      %  \cvsubentry{}{Smart TV Penetration Testing}{March 2011 - Oct 2011}{}
      %\end{cvsubentries}
    }
