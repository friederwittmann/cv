...
%---------------------------------------------------------
  \cventry
    ...
    {1 Sep. 2021 - 31 Jan. 2024} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Prototyping and software development in cross-functional teams in healthcare and mixed reality}
        \item {Development of methods and procedures for object tracking using computer vision and machine learning}
        \item {Development of methods and procedures for 3D object reconstruction from point clouds using computer vision and machine learning}
        \item {Development of methods and procedures for attention analysis using eye tracking}
        \item {Technical validation of developed methods and procedures as part of regulatory approval for medical devices}
        \item {Collaboration with UX experts and software engineers}
        \item {Ensured software development process quality, including unit tests and source code reviews}
        \item {Execution of software testing and quality assurance activities}
        \item {Key technologies: Atlassian Confluence, Jira, Git (GitLab), OpenCV, PyCharm, Unity 3D, Visual Studio, C\#, C++, Python}
      \end{cvitems}
    }
  ...
  \cventry
    ...
    {Zurich, Switzerland} % Location
    {January 2018 - 31 May 2021} % Date(s)
    {
      \begin{cvitems} % Description(s) of tasks/responsibilities
        \item {Project lead in multiple engineering projects on optimization of Wheelchairs and Sport Climbing, including:}
        \item{Colaboration with Sauber Enginnering and Orthotec for paralympic athelte Marcel Hug, which supported his wins at the Tokyo \& Paris Paralympics: 5 Gold, 2 Silver, 1 Bronze medals as well as one world record (1500m). The project was featured multiple times on Swiss public television (SRF).}
